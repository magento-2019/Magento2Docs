...
define(['jquery', 'underscore', 'jquery/ui','quickSwatchRenderer'], function ($, _) {
    'use strict';
     ...
     */
    $.widget('magearray_quickview.quickSwatchRenderer', {
        options: {
            classes: {
			...
			productId:{},
            selectorProduct: '#cboxContent',             // selector of parental block of prices and swatches (need to know where to seek for price block)
            selectorProductPrice: {},      // selector of price wrapper (need to know where set price)
         ...
         */
        _init: function () {
			this.options.selectorProductPrice='div[data-product-id='+this.options.productId+']';
        ...
        _EnableProductMediaLoader: function ($this) {
            ...
            if ($('body.catalog-product-view').size() > 0) {
                ...
                //Category View
                $('#cboxContent').find('[data-gallery-role="gallery"]')
                    .addClass($widget.options.classes.loader);
            }
        },
        ...
        _ProductMediaCallback: function ($this, response) {
            ...
            if ($widget._ObjectLength(response) < 1) {
                this.updateBaseImage(this.options.mediaGalleryInitial);
        ...
        updateBaseImage: function (images) {
              var img_src=images['0'].img;  
$("#cboxContent").find('[data-gallery-role="gallery"] img').attr('src',img_src);
        },
	...
	return $.magearray_quickview.quickSwatchRenderer;
});
