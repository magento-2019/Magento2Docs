...
namespace MageArray\Quickview\Block\Product\Renderer;
...
class Configurable extends \Magento\ConfigurableProduct\Block\Product\View\Type\Configurable
{
     ...
     */
    const SWATCH_RENDERER_TEMPLATE = 'MageArray_Quickview::product/view/renderer.phtml';

    /**
     * Do changes for Path to default template file with standard Configurable renderer for popup content.
     */
    const CONFIGURABLE_RENDERER_TEMPLATE = 'MageArray_Quickview::configurable.phtml';
    ...
    public function setProduct(Product $product)
    {
		...
		print_r(get_class_methods($product));die;
        return $this;
    }
